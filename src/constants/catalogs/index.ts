...
export const catalogs: IPrimitive[] = [
	...
	},
	{
		...
		image: './catalogs/black_dragon/black_dragon.png',
		attributes: [
			{
				attribute: 'gltf-model',
	...
	},
	{
		...
		image: './catalogs/transformer/transformer.png',
		attributes: [
			{
				attribute: 'obj-model',
				default: {
	...
	},
	{
		...
		url: 'https://github.com/aframevr/aframe/blob/master/docs/components/obj-model.md',
		image: './catalogs/virtual_city/virtual_city.png',
		attributes: [
			{
				attribute: 'gltf-model',
				default: 'https://cdn.aframe.io/test-models/models/glTF-2.0/virtualcity/VC.gltf',
			},
			{
				attribute: 'animation-mixer.duration',
				default: '0',
